        ...
        if (photos != null && !photos.isEmpty()) {
            ...
            for (PhotoMeta meta : photos) {
                ...
                SegmentPhoto photo = SegmentPhoto.builder()
                        ...
                        .locationName(meta.getLocationName() == null || meta.getLocationName().isBlank()
                                ? geocodingService.reverseGeocode(meta.getLatitude(), meta.getLongitude())
                                : meta.getLocationName())
                        .build();
            ...
            SegmentPhoto photo = SegmentPhoto.builder()
                    ...
                    .latitude(request.getLatitude())
                    .longitude(request.getLongitude())
                    .locationName(request.getLocationName() == null || request.getLocationName().isBlank()
